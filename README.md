...
* **Formación:** Estudiante de tercer año de Ingeniería Civil Informática en la Pontificia Universidad Católica de Valparaíso (PUCV).
* **Intereses:** Apasionado por el desarrollo de software, la aplicación de Inteligencia Artificial para la resolución de problemas y la optimización de algoritmos.
* **Enfoque técnico:** Interesado en el diseño de bases de datos relacionales y la creación de simulaciones numéricas/científicas.
